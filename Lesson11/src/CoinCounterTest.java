...
public class CoinCounterTest {
    ...
    public void testTerribleDenominations() throws Exception {
        ...
        assertEquals("failing for 1", CoinCounter.CHANGE_NOT_POSSIBLE_FLAG, terribleDenominations.recursiveNumberOfCoinsRequired(1));
        assertEquals(1, terribleDenominations.recursiveNumberOfCoinsRequired(2));
        assertEquals("failing for 3",CoinCounter.CHANGE_NOT_POSSIBLE_FLAG, terribleDenominations.recursiveNumberOfCoinsRequired(3));
